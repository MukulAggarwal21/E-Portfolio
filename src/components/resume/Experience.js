...
const Experience = () => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1, transition: { duration: 0.5 } }}
      className="py-12 font-titleFont flex flex-col lgl:flex-row gap-6 lgl:gap-20"
    >
      <div className="flex">
        <div className="flex flex-col gap-4">
          {/* <p className="text-sm text-designColor tracking-[4px]">2010 - 2022</p>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-auto lgl:h-[1000px] border-l-[3px] lgl:border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-6 lgl:gap-10">
          ...
          <ResumeCard
            ...
            subTitle="Talenrn (Sep 2023- March 2024"
            result="Remote"
            des="Developed a dynamic web solution with React.js and Tailwind CSS, collaborating with cross-functional teams to improve accessibility and performance through code optimization and responsive design."
          />
          <ResumeCard
            title="Administrator"
            subTitle=" CPByte, Kiet Group Of Institutions (May 2023 -Present)"
      ...
      <div className="flex-1 mt-6 lgl:mt-0">
        <div className="flex flex-col gap-4">
          {/* <p className="text-sm text-designColor tracking-[4px]">2001 - 2020</p>
          <h2 className="text-4xl font-bold">Trainer Experience</h2>
         */}
